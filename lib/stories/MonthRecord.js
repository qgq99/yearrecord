...
var MonthRecord = function (_a) {
    ...
    var _o = useMemo(function () { return getMaxAndMinValue(data.map(function (_) { return _.data; })); }, []), mxData = _o[0], mnData = _o[1];
    return (jsx(Fragment, { children: jsxs("div", { style: {
                ...
                alignItems: "center"
                            ...
                            return (jsx(Tooltip, { title: tooltipTitileFunc(v), placement: tooltipTitlePlacement, children: jsx("div", { className: "day-record", style: {
                                        "--itemBorderRadius": itemBorderRadius,
